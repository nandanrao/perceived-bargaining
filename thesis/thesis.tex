...
% \subsection{ Any Concave Utility Function }

% \begin{align*}
%   \frac{1}{xn}u(W) \geq u \left( \frac{1}{x} u^{-1}\left( \frac{1}{n} u \left( W \right) \right) \right)
% \end{align*}
% The inverse of an increasing concave function is an increasing convex function. Restricting the analysis to the domain of the positive reals, therefore:
% \begin{align*}
%   \frac{1}{n} u^{-1}(u(W))  \geq  u^{-1}(\frac{1}{n}u(W))
% \end{align*}
% However,
% \begin{align*}
%   \frac{1}{xn}u(W) \leq u( \frac{1}{xn} W)
% \end{align*}
